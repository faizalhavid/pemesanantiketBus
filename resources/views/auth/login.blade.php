@extends('layout.auth')
@section('container-2')
<h1 class="sub-title text-center">Login Page</h1>
<div class="menu mx-4 my-2">
    <a href="/register" class="badge badge-primary">Register</a>
</div>
{{--  allert  --}}
...
<form action="/proses_login" class="mx-4 mb-3" method="POST" enctype="multipart/form-data">
    @csrf
